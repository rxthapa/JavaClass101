...
public class BankTest {
	public static void main(String[] args) {
		...
		//b2.increaseSalary("Roshan", 1000);
		System.out.println(b1.getAddressLocation());
		System.out.println(b2.getAddressLocation());
		Employee[] allempl = b2.getEmployeelist();
		System.out.println(allempl.length);
		
	
		
		for (int i = 0; i < allempl.length; i++) {
			System.out.println(allempl[i].getFname());
			System.out.println(allempl[i].getSalary());
		}
